...
$(function(){ //브라우저에 모두 표시되면 실행되는 함수 - whindow.onload
    //빙고시작 버튼 클릭 이벤트
    $("#start").click(start); 
    $(".num").click(bingoCheck) //숫자가 표시된 td를 클릭하면...
    // var tdClick=document.getElementsByIdClassName("num");
...
function bingoCheck(){
    ...
    //4번째 td클릭하면 idx3이고 bingo[3]=0으로 변경하겠다는 내용

        /*
        빙고 몇줄??
        가로 세로 대각선 빙고인지 확인하는 내용가
